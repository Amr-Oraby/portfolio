...
function About() {
  return (
    <div className="min-h-[600px] relative flex flex-col sm:flex-row gap-6 md:gap-8 xl:gap-20 2xl:gap-30  justify-between items-center sm:items-start py-15 px-5 sm:px-10 md:px-15  pr-5 sm:pr-14 md:pr-24">
      ...
      <div className="text ">
        ...
        >
          <h1 className="text-[35px] sm:text-[40px] xl:text-[60px]">
            More about
          </h1>
          <h1 className="text-[35px] sm:text-[40px] xl:text-[60px]">
            the developer.
        ...
        <div className="mt-10 space-y-10">
          ...
          <p className="text-gray-600 text-sm max-w-[230px]">
            i build fast,accessible and beautiful digital experiences that solve
            real problems and create impact.
          </p>
      ...
      <div className="accordion grid grid-cols-[repeat(auto-fill,minmax(260px,1fr))] gap-5 flex-1">
